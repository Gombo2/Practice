...
public class ResolverController {
    ...
    public String stringReturning(Model model) {
        model.addAttribute("forwardMessage", "문자열로 뷰 이름 변환됨...");
    ...
    public String stringRedirect(Model model) {
        ...
        /* 설명. redirect 되어 요청이 됐을 때 응답되는 view의 재료가 된다.(지금은 model에 담긴 값이 전달되지 않음) */
    ...
    public String stringRedirectFlashAttribute(RedirectAttributes rttr) {
        ...
        /* 설명. 스프링 부트에서 리다이렉트 시에 값이 전달되게 하고 싶다면 RedirectAttributes를 활용한다.*/
