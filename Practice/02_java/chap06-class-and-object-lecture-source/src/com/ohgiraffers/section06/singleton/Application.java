...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        EagerSingleton eagar1 = EagerSingleton.getInstance();
        EagerSingleton eagar2 = EagerSingleton.getInstance();

        System.out.println("eagar1 의 주소 = " + System.identityHashCode(eagar1));
        System.out.println("eagar2 의 주소 = " + System.identityHashCode(eagar2));

        LazySingleton lazy1 = LazySingleton.getInstance(); // LazySingleton은 최초 호출 시 객체가 할당
        LazySingleton lazy2 = LazySingleton.getInstance();
        System.out.println("lazy1 의 주소 = " + System.identityHashCode(eagar1));
        System.out.println("lazy2 의 주소 = " + System.identityHashCode(eagar2));
    }
}
