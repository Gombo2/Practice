...
public class Application {
    public static void main(String[] args) {
        ...
        /* 수업목표. 단순 정수 열거 패턴과 이의 단점을 이해할 수 있다.(enum이 아닐때)*/
        int subject1 = Subjects.JAVA;
        int subject2 = Subjects.HTML;


        /* 설명. 1. 둘다 같은 상수이자 숫자일 뿐 구분할 수 없다.(런타임 시점) */
        if (subject1 == subject2) {
            System.out.println("두 과목은 같은 과목입니다. ");
        }

        /* 설명. 2. 변수명에 쓰인 이름(문자열을 출력하기 어렵다) (feat.switch). */
        ...
        /* 설명. 3. 같은 클래스에 속한 상수들을 순회(반복자/반복문)할 수 있다.
        *          (필드가 총 몇 개이고 어던 것들이 있는지)
        * */
