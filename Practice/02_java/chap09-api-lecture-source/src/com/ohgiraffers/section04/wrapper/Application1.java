...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("equlas() 비교: " + integerTest.equals(integerTest2));
        /* 설명. 모든 Wrapper 클래스들도 constant pool을 활용해 동등 객체는 하나만(동일 인스턴스로) 지정한다. */
    ...
    private static void anythingMethod(Object obj) {
        ...
        /* 설명. int -> Intgger(오토박싱) -> Object(다형성)*/
        /* 설명. 출력 -> Object의 toString() 에서 Integer의 toString()(동적바인딩)이 실행됨*/
