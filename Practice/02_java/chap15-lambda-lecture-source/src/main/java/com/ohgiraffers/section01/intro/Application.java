...
//        Calculator cal = new Calculator();  //안됨.(인터페이스이기에)
        ...
        *   설명.
        *    기본 람다식 규칙
        *    1. 매게변수의 소괄호(())는 생략할 수 없지만, 매개변수가 하나인 추상 메소드는 소괄호도
        *       생략 가능하다. (ex. x -> 1 + x;
        *    2. 구현하는 메소드의 바디부분에서 실행 구문이 하나일 경우 중괄호({})가 생략 가능하다.
        *    3. 실행 될 마지막 구문이 리터럴 형태로 끝나고 추상메소드에 반환형이 있을 경우 return이
        *       생략 가능하다.
        * */
//        Calculator cal3 = (int first, int second) -> {
//            return first + second;
//        };
