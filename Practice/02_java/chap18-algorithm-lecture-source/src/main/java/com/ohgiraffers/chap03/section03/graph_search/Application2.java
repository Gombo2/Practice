...
/* 수업목표. BFS와 x, y 좌표를 활용한 문제를 해결할 수 있다.(feat. 배열 인덱스와 좌표는 반대 개념) */
/* 설명.
...
public class Application2 {
    ...
    /* 설명. 방문 배열 (2차원 배열, 1차원 배열 적용을 고민해봐야함. 양방향-> 1차원. 대칭되지 않을 경우 (단방향) -> 2차원 배열) */
    ...
    /* 설명. 배추가 상하좌우를 보고 방문 하지 않고 유효한 범위 안에 또다른 배추가 심어져 있는지 확인(방문배열 체크) */
